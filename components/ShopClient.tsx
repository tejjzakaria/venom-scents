      ...
      <div className="relative bg-[#0A0A0A] overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 md:px-10 py-12 md:py-20">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-6">
            <div>
              <h1 className="text-white font-bold font-serif text-[36px] md:text-[64px] leading-[1.05] mb-2 md:mb-3">{heroTitle ?? t.title}</h1>
              <p className="text-white/50 font-sans text-xs md:text-sm max-w-[360px] leading-relaxed">{heroSubtitle ?? t.subtitle}</p>
            </div>
            <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-full px-4 py-2.5 md:px-5 md:py-3 self-start md:self-auto">
              <StarRating rating={5} />
              <span className="text-white/70 text-xs font-sans">{heroStatsText ?? t.statsText}</span>
            </div>
          </div>
        </div>
      </div>
