...
export default function WhatsAppWidget({ phone }: { phone: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-transform duration-200"
