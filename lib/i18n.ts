...
const dict: Record<Locale, Translations> = {
  en: {
    ...
    footer: { tagline: 'Quality crafted to make you stand out.', shopAll: 'Shop All', ourStory: 'Our Story', home: 'Home', contact: 'Contact' },
    ...
    shop: {
      ...
      subtitle: 'Every product crafted to captivate. Find your perfect match below.',
    ...
    contact: {
      eyebrow: 'Get in Touch', fallbackDesc: "A question, a compliment, or just want to chat — our team is here for all of it.",
  ...
  fr: {
    ...
    footer: { tagline: "La qualité qui vous démarque.", shopAll: 'Voir tout', ourStory: 'Notre Histoire', home: 'Accueil', contact: 'Contact' },
    ...
    shop: {
      title: 'La Collection',
      subtitle: 'Chaque produit conçu pour captiver. Trouvez votre choix parfait ci-dessous.',
    ...
    contact: {
      eyebrow: 'Contactez-nous', fallbackDesc: "Une question, un compliment, ou juste envie de discuter — notre équipe est là pour tout.",
  ...
  ar: {
    ...
    footer: { tagline: 'جودة تجعلك مميزاً.', shopAll: 'تسوق الكل', ourStory: 'قصتنا', home: 'الرئيسية', contact: 'تواصل معنا' },
    ...
    shop: {
      title: 'المجموعة',
      subtitle: 'كل منتج مصنوع ليأسرك. اعثر على ما يناسبك أدناه.',
    ...
    contact: {
      eyebrow: 'تواصل معنا', fallbackDesc: 'سؤال، أو إطراء، أو مجرد للحديث — فريقنا هنا لكل شيء.',
